	...
	override fun getBody() : (ActorBasicFsm.() -> Unit){
		...
		return { //this:ActionBasciFsm
				state("s0") { //this:State
					...
					transition(edgeName="t033",targetState="set_full",cond=whenDispatch("test_hold_full"))
					transition(edgeName="t034",targetState="set_empty",cond=whenDispatch("test_hold_empty"))
				}	 
