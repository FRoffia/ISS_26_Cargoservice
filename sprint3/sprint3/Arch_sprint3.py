...
### see https://renenyffenegger.ch/notes/tools/Graphviz/attributes/label/HTML-like/index
     ...
     cargoservice >> Edge(color='magenta', style='solid', decorate='true', label='<get_hold_status<font color="darkgreen"> hold_status</font> &nbsp; reserve_slot<font color="darkgreen"> reserve_ok reserve_fail</font> &nbsp; >',  fontcolor='magenta') >> holdservice
