...
### see https://renenyffenegger.ch/notes/tools/Graphviz/attributes/label/HTML-like/index
     ...
     holdstatusservice >> Edge(color='magenta', style='solid', decorate='true', label='<get_hold_status<font color="darkgreen"> hold_status</font> &nbsp; >',  fontcolor='magenta') >> cargoservice
